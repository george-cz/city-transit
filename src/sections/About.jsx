        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-2 lg:order-1">
              <div className="aspect-square rounded-2xl bg-gradient-to-br from-amber-600 to-orange-700 shadow-2xl flex items-center justify-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <ul className="space-y-4 mb-8">
                {benefits.map((benefit, index) => (
                  <li key={index} className="flex items-start gap-3">
                    <div className="flex-shrink-0 w-6 h-6 bg-amber-800 rounded-full flex items-center justify-center mt-1">
              ...
              <button className="bg-amber-800 hover:bg-amber-900 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-200 shadow-lg hover:shadow-xl">
                Get Your Copy
              </button>
            </div>
          </div>
